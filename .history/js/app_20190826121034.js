...
form.addEventListener('submit', e =>{
    ...
    function bodyPOST() {
        ...
        <br>
        <br>
        <button onclick="addNameAndSurname()" type="submit" class="btn btn-primary ml-1">Second endpoint</button>
        `

        let name = document.getElementById("name")
        let surname = document.getElementById("surname")

        function addNameAndSurname(){
            let token = localStorage.getItem("token")


            let objBody = JSON.stringify({"name" : name, "surname" : "Fleitas"})
