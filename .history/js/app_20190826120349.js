...
form.addEventListener('submit', e =>{
    ...
    function bodyPOST() {
        ...
        lpm.innerHTML=`
        <input class="mt-1 ml-1" type="text" name="surname" id="surname" placeholder="User">
        <br>
        <br>
        <input class="ml-1" type="password" name="surname" id="surname" placeholder="Password">
        <br>
        <br>
        <button type="submit" class="btn btn-primary ml-1">first endpoint</button>
        `
